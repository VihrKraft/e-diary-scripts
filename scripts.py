...
def get_student(schoolkid):
    try:
        ...
        print('Найдено больше 1 ученика. Введите более точный запрос.')
    except Schoolkid.DoesNotExist:
        print('Ученик не найден. Повторите запрос, исправив ошибки.')
...
def get_subject(subject_name, student):
    try:
        ...
        print('Найдено больше 1 предмета. Введите более точный запрос.')
    except Subject.DoesNotExist:
        print('Предмет не найден. Повторите запрос, исправив ошибки.')
...
def create_commendation(schoolkid, subject_name):
    ...
    if subject and student:
        ...
        comendation_text = random.choice(
            [
                'Молодец',
                'Хвалю!',
