...
def get_student_excepts(schoolkid):
    try:
...
def get_subject_excepts(name_subject, student):
    try:
        if student:
...
def fix_marks(schoolkid):
    student = get_student_excepts(schoolkid)
    if student:
...
def create_commendation(schoolkid, name_subject):
    student = get_student_excepts(schoolkid)
    subject = get_subject_excepts(name_subject, student)
